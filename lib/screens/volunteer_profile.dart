...
class VolunteerProfileScreen2 extends StatelessWidget {
  ...
  Widget _avatarWithRank() {
    final imageUrl = vol.personalImage;
  ...
  Widget build(BuildContext context) {
    final prov = context.read<VolunteerProvider>();

    final birth = _formatDate(vol.birthDate);
    final gender = _formatGender(vol.gender);
    final email = vol.email;
    final phone = vol.mobileNumber;
    final dept = vol.department;
    final whatsapp = vol.whatsappNumber;
    final points = (vol.points).toString();
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            _buildInfoRowWithDivider("القسم", dept.name),
